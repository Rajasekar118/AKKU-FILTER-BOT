...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url=f"https://t.me/Jitham_Movies"), 
                    InlineKeyboardButton('ʟᴜᴄʏ', url=f"https://t.me/AKKU_Filter_bot") 
                ],[
                    InlineKeyboardButton('ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ', url=f"https://t.me/Akku_Bot_Official")
                ],[
